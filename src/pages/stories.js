  ...
  return (
    <>
      ...
      <section className={styles.noa}>
        <div className={styles.text}>
          <p>Hi I’m Noa and I got spiked while I was out clubbing with some friends. Out of the blue I was extremely drunk, which came out of nowhere because I hadn’t drank that much. I felt really hot, got a <span>nosebleed, couldn’t walk properly</span> and when I got home I <span>threw up</span> for the first time in twelve years. </p>
